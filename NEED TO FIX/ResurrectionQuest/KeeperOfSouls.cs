...
{
    [CorpseName("a keeper of souls corpse")]
    public class KeeperOfSouls : BaseSABosses
    {
        ...
        [Constructable]
        public KeeperOfSouls()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "The Keeper of Souls";
            this.Hue = 1917;
            this.Body = 741;
            ...
            PackItem(new ClothingBlessDeed ( 2 ) );
            PackItem(new PetBondingDeed());
        }

        public KeeperOfSouls(Serial serial)
            : base(serial)
        {
        }
        ...
        public void DrainMana()
        {
            ...
            foreach (Mobile m in list)
            {
                ...
                m.SendMessage("You challenged me, now you will perish here!");
