...
namespace Server.Mobiles
{
	...
	public class BlazeColossus : BaseCreature
	{

		[Constructable]
		public BlazeColossus() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a blaze colossus";
			Hue = 1161;
			Body = 0x33D;
			BaseSoundID = 268;
		...
		public override void OnDeath( Container c )
		{
			...
			BlazeGranite granite = new BlazeGranite();
   			granite.Amount = 10;
   			c.DropItem(granite);
		...
		public BlazeColossus( Serial serial ) : base( serial )
		{
		}
