...
namespace Server.Mobiles
{
	...
	public class ToxicColossus : BaseCreature
	{

		[Constructable]
		public ToxicColossus() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a toxic colossus";
			Hue = 1272;
			Body = 0x33D;
			BaseSoundID = 268;
		...
		public override void OnDeath( Container c )
		{
			...
			ToxicGranite granite = new ToxicGranite();
   			granite.Amount = 10;
   			c.DropItem(granite);
		...
		public ToxicColossus( Serial serial ) : base( serial )
		{
		}
