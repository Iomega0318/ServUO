...
namespace Server.Mobiles
{
	...
	public class ElectrumColossus : BaseCreature
	{

		[Constructable]
		public ElectrumColossus() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a electrum colossus";
			Hue = 1278;
			Body = 0x33D;
			BaseSoundID = 268;
		...
		public override void OnDeath( Container c )
		{
			...
			ElectrumGranite granite = new ElectrumGranite();
   			granite.Amount = 10;
   			c.DropItem(granite);
		...
		public ElectrumColossus( Serial serial ) : base( serial )
		{
		}
