...
namespace Server.Mobiles
{
	...
	public class PlatinumColossus : BaseCreature
	{

		[Constructable]
		public PlatinumColossus() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a platinum colossus";
			Hue = 1153;
			Body = 0x33D;
			BaseSoundID = 268;
		...
		public override void OnDeath( Container c )
		{
			...
			PlatinumGranite granite = new PlatinumGranite();
   			granite.Amount = 10;
   			c.DropItem(granite);
		...
		public PlatinumColossus( Serial serial ) : base( serial )
		{
		}
