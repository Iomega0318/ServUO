...
{
    [CorpseName("a black horse corpse")]
	public class BlackHorse : BaseMount
	{
		...
		[Constructable]
		public BlackHorse( string name ) : base( name, 0x74, 0x3EA7, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0xA8;
            Hue = 1109;
			SetStr( 496, 525 );
			...
			SetSkill( SkillName.Magery, 101.4, 120.0 );
