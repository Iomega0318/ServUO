...
{
	public class PredatorsRobe : BaseOuterTorso
	{
                public override int ArtifactRarity{ get{ return 10; } }
		[Constructable]
		public PredatorsRobe() : base( 0x2684 )	// Hooded Shroud
		{	
			Hue = 0;	// No Color
            Name = "Predators Robe";
		...
		public PredatorsRobe( Serial serial ) : base( serial )
		{
		}
		...
		public override bool OnEquip( Mobile from )
		{
            ...
            from.SendMessage("You feel the power of the Predator taking over your body!");
