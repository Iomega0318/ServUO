...
namespace Server.Mobiles
{
	...
	public class SyntheticDragon : BaseCreature
	{
		[Constructable]
		public SyntheticDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Synthetic Dragon";
        ...
        public SyntheticDragon(Serial serial)
            : base(serial)
		{
		}
