...
namespace Server.Mobiles
{
	...
	public class BlazeDragon : BaseCreature
	{
		[Constructable]
		public BlazeDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Blaze Dragon";
		...
		public BlazeDragon( Serial serial ) : base( serial )
		{
		}
