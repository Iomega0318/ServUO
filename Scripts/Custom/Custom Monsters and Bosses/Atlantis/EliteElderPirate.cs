...
{
	[CorpseName( "a corpse of a Elite Elder Pirate" )]
	public class EliteElderPirate : BaseCreature
	{
		private static bool m_Talked;
		string[] EliteElderPirateSay = new string[] 
		{ 
		...
		[Constructable]
		public EliteElderPirate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			SpeechHue = Utility.RandomDyedHue();
			Title = "the Elite Elder Pirate";
			...
			SetSkill( SkillName.Swords, 120.5 );
			SetSkill( SkillName.Tactics, 135.0, 160.5 );
			SetSkill( SkillName.Wrestling, 120.3 );
		...
		
			{
             ...
             case 0:	PackItem( new PirateChest() ); break;
             case 1:	PackItem( new PirateLegs() ); break;
             case 2:	PackItem( new MagicAtlantisBall() ); break;
             case 3:	PackItem( new PirateBlade() ); break;
			 case 4:	PackItem( new PirateTreasurePart2() ); break;
        		...
        		public override void OnMovement( Mobile m, Point3D oldLocation ) 
                	{                                                    
        	  		...
        	  		{ 
        				...
        				{                
            		   			m_Talked = true; 
            		   			SayRandom( EliteElderPirateSay, this ); 
			...
			public EliteElderPirate( Serial serial ) : base( serial )
			{
			}
