		...
		public override void OnStart()
		{
			if( !this.IsRunning )
			{
				switch( Utility.Random(6) )
				{
					...
					//Added Towns 09/23/2021
					case 6:  //BuccaneersDen
					{
						this.Top = new Point3D(2608, 2060, 0);
						this.Bottom = new Point3D(2824, 2296, 0);
						this.MinSpawnZ = 50;
						this.MaxSpawnZ = 61;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Buccaneer's Den";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 7:  //Cove
					{
						this.Top = new Point3D(2213, 1148, 0);
						this.Bottom = new Point3D(2284, 1233, 0);
						this.MinSpawnZ = 50;
						this.MaxSpawnZ = 61;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Cove";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 8:  //Jhelom
					{
						this.Top = new Point3D(1304, 3682, 0);
						this.Bottom = new Point3D(1465, 3877, 0);
						this.MinSpawnZ = 0;
						this.MaxSpawnZ = 31;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Jhelom";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 9:  //Nujel'm
					{
						this.Top = new Point3D(3665, 1189, 0);
						this.Bottom = new Point3D(3774, 1357, 0);
						this.MinSpawnZ = 0;
						this.MaxSpawnZ = 31;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Nujel'm";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 10:  //Papua
					{
						this.Top = new Point3D(5644, 3112, -15);
						this.Bottom = new Point3D(5826, 3315, 0);
						this.MinSpawnZ = 0;
						this.MaxSpawnZ = 31;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Papua";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 11:  //Vesper
					{
						this.Top = new Point3D(2835, 656, 0);
						this.Bottom = new Point3D(2940, 988, 0);
						this.MinSpawnZ = 0;
						this.MaxSpawnZ = 31;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Vesper";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
						
						break;
					}
					case 12:  //Serperent's Hold
					{
						this.Top = new Point3D(2935, 3343, 55);
						this.Bottom = new Point3D(3048, 3463, 15);
						this.MinSpawnZ = 15;
						this.MaxSpawnZ = 61;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Serperent's Hold";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
					...
					case 13:  //Trinsic
					{
						this.Top = new Point3D(1834, 2686, 0);
						this.Bottom = new Point3D(1954, 2822, 0);
						this.MinSpawnZ = 0;
						this.MaxSpawnZ = 31;
						this.SpawnMap = Map.Felucca;
						this.TownInvaded = "Trinsic";
						this.TownMonsterType = TownMonsterType.Abyss;
						this.TownChampionType = TownChampionType.Rikktor;
