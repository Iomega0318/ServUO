...
namespace Server.Scripts.Commands
{
    public class SetCharacterSlots
    {
        ...
        [Description("Sets the targeted players character slots, NOTE: Value can only be between 1 and 7.")]
        ...
        public class CharSlotTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                if (o is PlayerMobile)
                {
                    ...
                    if ( /*m_Amount > 1 && m_Amount < 5 || */m_Amount > 7 || m_Amount < 1)
                    {
                        from.SendMessage("Bad Format. Value must be 1, 2, 3, 4, 5, 6, or 7.");
                        return;
                    }
