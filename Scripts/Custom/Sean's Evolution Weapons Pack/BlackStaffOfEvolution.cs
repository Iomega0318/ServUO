...
{
	public class BlackStaffOfEvolution : BlackStaff
	{
		...
		[Constructable]
		public BlackStaffOfEvolution()
		{	Name = "Black Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public BlackStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Black Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
