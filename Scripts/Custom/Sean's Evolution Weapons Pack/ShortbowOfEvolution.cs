...
{
	public class ShortbowOfEvolution : MagicalShortbow
	{
		...
		[Constructable]
		public ShortbowOfEvolution()
		{	Name = "Shortbow Of Evolution";
			Hue = 0x4F2;
        ...
        public ShortbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Shortbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
