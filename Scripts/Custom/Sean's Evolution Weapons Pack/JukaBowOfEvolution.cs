...
{
	public class JukaBowOfEvolution : JukaBow
	{
		...
		[Constructable]
		public JukaBowOfEvolution()
		{	Name = "Juka Bow Of Evolution";
			Hue = 0x4F2;
        ...
        public JukaBowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Juka Bow Of Evolution (" + mEvolutionPoints.ToString() + ")";
