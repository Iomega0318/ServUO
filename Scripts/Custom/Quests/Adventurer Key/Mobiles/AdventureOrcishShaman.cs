...
namespace Server.Mobiles
{
	...
	public class AdventureOrcishShaman : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public AdventureOrcishShaman () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AdventureOrcishShaman( Serial serial ) : base( serial )
		{
		}
