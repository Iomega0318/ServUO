...
namespace Server.Mobiles
{
    ...
    public class AdventureOrcBrute : BaseCreature
    {
        [Constructable]
        public AdventureOrcBrute()
        ...
        public AdventureOrcBrute(Serial serial)
            : base(serial)
        {
        }
        ...
        public override int Damage(int amount, Mobile from, bool informMount, bool checkDisrupt)
        {
            ...
            {
                SpawnAdventureOrcLord(from);
            }

            return damage;
        }

        public void SpawnAdventureOrcLord(Mobile target)
        {
            Map map = target.Map;
