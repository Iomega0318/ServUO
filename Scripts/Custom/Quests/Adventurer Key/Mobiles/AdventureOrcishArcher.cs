...
namespace Server.Mobiles
{
	...
	public class AdventureOrcishArcher : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public AdventureOrcishArcher() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AdventureOrcishArcher( Serial serial ) : base( serial )
		{
		}
