...
{
	public class FemaleGargoyleATASoulArmor : LeatherChest
	{
		...
		[Constructable]
		public FemaleGargoyleATASoulArmor()
		{
			Name = "Female Gargoyle ATA Soul Armor";
            ItemID = 771;
            Hue = 1154;
		...
		public FemaleGargoyleATASoulArmor ( Serial serial ) : base( serial )
		{
		}
