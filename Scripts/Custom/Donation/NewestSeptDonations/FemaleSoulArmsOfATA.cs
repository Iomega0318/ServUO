...
{
	public class FemaleSoulArmsOfATA : LeatherArms
	{
		...
		[Constructable]
		public FemaleSoulArmsOfATA()
		{
			Hue = 0;
			ItemID = 21463;
			
			Name = "Female Soul Arms Of ATA";
		...
		public FemaleSoulArmsOfATA( Serial serial ) : base( serial )
		{
		}
