...
{	
	public class MaleGargoyleSoulKiltOfATA : BaseArmor
	{
		...
		[Constructable]
        public MaleGargoyleSoulKiltOfATA()
            : base(0x0408)
		{
            Name = "Male Gargoyle Soul Kilt Of ATA";
            Hue = 1154;
			Weight = 2.0;
            ItemID = 785;
        ...
        public MaleGargoyleSoulKiltOfATA(Serial serial)
            : base(serial)
		{
		}
