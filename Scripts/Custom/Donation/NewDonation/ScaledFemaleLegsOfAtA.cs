...
{
	public class ScaledFemaleLegsOfAtA : ChainLegs
	{
		...
		[Constructable]
		public ScaledFemaleLegsOfAtA()
		{
			ItemID = 21400;
			Hue = 0;
			
			Name = "Scaled Female Legs Of AtA";
		...
		public ScaledFemaleLegsOfAtA( Serial serial ) : base( serial )
		{
		}
