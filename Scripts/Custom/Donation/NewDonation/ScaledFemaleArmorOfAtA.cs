...
{
	public class ScaledFemaleArmorOfAtA : LeatherChest
	{
		...
		[Constructable]
		public ScaledFemaleArmorOfAtA()
		{
			Name = "Scaled Female Armor Of AtA";
			Hue = 0;
		    ItemID = 21402;
		...
		public ScaledFemaleArmorOfAtA ( Serial serial ) : base( serial )
		{
		}
