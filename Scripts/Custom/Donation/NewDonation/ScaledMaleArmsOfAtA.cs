...
{
	public class ScaledMaleArmsOfAtA : LeatherArms
	{
		...
		[Constructable]
		public ScaledMaleArmsOfAtA()
		{
			Hue = 0;
			ItemID = 21399;
			
			Name = "Scaled Male Arms Of AtA";
		...
		public ScaledMaleArmsOfAtA( Serial serial ) : base( serial )
		{
		}
