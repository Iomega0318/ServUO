...
namespace Solaris.ItemStore
{
    ...
    public class ItemListEntry : IComparable
    {
        ...
        public virtual int GumpWidth => 400;
            ...
            get
            {
                if (_Columns == null)
                {
                    _Columns = new List<ItemListEntryColumn>
                    {
                        ...
                        new ItemListEntryColumn(0, "Name", _Name)
                    };
                }
        ...
        public ItemListEntry(Item item) : this(item, item.Name ?? item.GetType().Name)
        {
        }
    ...
    {
        public override int GumpWidth => 400;
        ...
        //public accessors
        public Point2D ChestLocation => _ChestLocation;
        public Map ChestMap => _ChestMap;
        public Mobile Decoder => _Decoder;
    ...
    public class SOSListEntry : ItemListEntry
    {
        ...
        public Map TargetMap => _TargetMap;
        public Point3D TargetLocation => _TargetLocation;
    ...
    {
        public override int GumpWidth => 750;
        ...
        public SlayerName Slayer => _Slayer;
        public SlayerName Slayer2 => _Slayer2;
        public Mobile Crafter => _Crafter;
    ...
    {
        public override int GumpWidth => 500;
        ...
        public PlantHue PlantHue => _PlantHue;
    ...
    public class RepairDeedListEntry : ItemListEntry
    {
        ...
        //public accessors
        public RepairSkillType RepairSkillType => _RepairSkillType;
        ...
        {
            //awesome constructor!
            RepairDeed deed = new RepairDeed(RepairSkillType, _Level, _Crafter)
            {
                LootType = _LootType,
                Insured = _Insured
            };
