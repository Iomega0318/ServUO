...
namespace Server.Engines.PlayerDonation
{
	...
	public class DonationStore
	{
		...
		private static string
			DatabaseDriver = "{MySQL ODBC 8.0 Driver}",
			DatabaseServer = "localhost",	// your MySQL database hostname
			DatabaseName = "runuo_donation",			// the database name of your donation store db
			DatabaseUserID = "runuo",				// username for your MySQL database access
			DatabasePassword = "vDYCMkuRTuxxsaHMfYHDzFzCE";	// password
