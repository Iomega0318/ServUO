...
{  
	public class HalloweenOuiJaBoard2010 : Item
	{
           	[Constructable]
           	public HalloweenOuiJaBoard2010 ()
           	{
			ItemID = 4013;
           		Name = "a oui-ja board";
			...
			Hue = 1137;
           	...
           	[Constructable]
           	public HalloweenOuiJaBoard2010 (int amount)
           	{
           	}

           	public HalloweenOuiJaBoard2010 (Serial serial) : base( serial )
           	{
           	}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060662, "Halloween\t2010 " );
		}
