...
{
    public class LeprechaunsMug2010 : BaseBeverage
	{
		...
		[Constructable]
		public LeprechaunsMug2010()
		{
			Weight = 1.0;
			Name ="Leprechaun's Mug 2010";
			Hue = 52;
		}

		[Constructable]
		public LeprechaunsMug2010( BeverageType type ) : base( type )
		{
			Weight = 1.0;
		}

		public LeprechaunsMug2010( Serial serial ) : base( serial )
		{
		}
