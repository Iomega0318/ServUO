...
namespace Server.Gumps
{
	public class OzThothsStaticOtherGump : Gump
	{
		...
		public OzThothsStaticOtherGump(Mobile from): base(0, 0)
        {
			...
			AddHtml(547, 490, 86, 87, "<basefont color=#E6FBFF>[inc x # <br/>" +"[inc x -# <br/>" +"[inc y # <br/>" +"[inc y -#", false, false);
			AddHtml(860, 490, 101, 86, "<basefont color=#E6FBFF>[area inc x # <br/>" +"[area inc x -# <br/>" +"[area inc y # <br/>" +"[area inc y -#", false, false);
            AddHtml(490, 120, 464, 89, "<basefont size=5 color=#E6FBFF><center>ID# = Item ID.  R# = Number For Random.   <br/>" +"[Tile Static ID# R# [TileZ # ID# For Static Tiling At Z Height  [Add Static # [Tile Static # [Dupe to copy a static [Dupe # to copy # of statics of type.  [Inc x # y # z # increases/decreases multiple increments.", false, false);
			AddHtml(490, 90, 417, 19, "<basefont size=5 color=#E6FBFF><center>Helpful Tips", false, false);
			AddHtml(110, 110, 108, 60, "<basefont size=5><center>Oz'Thoth's Static Tool (Other Gump)", false, false);
            AddHtml(330, 220, 298, 18, "<basefont size=5 color=#E6FBFF><center>Single Height", false, false);
			AddHtml(650, 220, 298, 18, "<basefont size=5 color=#E6FBFF><center>Area Height", false, false);
			AddHtml(330, 340, 298, 18, "<basefont size=5 color=#E6FBFF><center>Single Direction", false, false);
			AddHtml(650, 340, 298, 18, "<basefont size=5 color=#E6FBFF><center>Area Direction", false, false);
			...
			AddHtml(117, 250, 80, 25, "<basefont size=5 color=#E6FBFF><center>Arches", false, false);
			...
			AddHtml(117, 310, 80, 25, "<basefont size=5 color=#E6FBFF><center>Fences", false, false);

			AddButton(97, 340, 5601, 5605, 64, GumpButtonType.Reply, 0);
			AddHtml(117, 340, 80, 25, "<basefont size=5 color=#E6FBFF><center>Floors", false, false);

			AddButton(97, 370, 5601, 5605, 65, GumpButtonType.Reply, 0);
			AddHtml(117, 370, 80, 25, "<basefont size=5 color=#E6FBFF><center>Plants", false, false);
			...
			AddHtml(117, 430, 80, 25, "<basefont size=5 color=#E6FBFF><center>Stairs", false, false);
			...
			AddHtml(227, 280, 80, 25, "<basefont size=5 color=#E6FBFF><center>Furniture", false, false);

			AddButton(207, 310, 5601, 5605, 74, GumpButtonType.Reply, 0);
			AddHtml(227, 310, 80, 25, "<basefont size=5 color=#E6FBFF><center>Dungeon", false, false);
			...
			AddHtml(227, 370, 80, 25, "<basefont size=5 color=#E6FBFF><center>Ground", false, false);

			AddButton(207, 400, 5601, 5605, 77, GumpButtonType.Reply, 0);
			AddHtml(227, 400, 80, 25, "<basefont size=5 color=#E6FBFF><center>Sign Post", false, false);
			...
			AddHtml(227, 460, 80, 25, "<basefont size=5 color=#E6FBFF><center>Nature", false, false);
			...
			AddHtml(227, 520, 80, 25, "<basefont size=5 color=#E6FBFF><center>Custom", false, false);
			...
			AddHtml(273, 110, 86, 20, "<basefont size=5 color=#E6FBFF><center>ItemID", false, false);
			...
			AddHtml(383, 130, 86, 20, "<basefont size=5 color=#E6FBFF><center>Delete", false, false);
			
			AddButton(253, 170, 22150, 22155, 87, GumpButtonType.Reply, 0);
			AddHtml(273, 170, 86, 20, "<basefont size=5 color=#E6FBFF><center>M Delete", false, false);

			AddButton(363, 170, 22150, 22155, 88, GumpButtonType.Reply, 0);
			AddHtml(383, 170, 96, 20, "<basefont size=5 color=#E6FBFF><center>Area Delete", false, false);
		...
		public MinStaticGump2(Mobile from) : this()
        {
            caller = from;
        }

		public MinStaticGump2() : base( 0, 0 )
        {
            this.Closable=false;
			...
			AddHtml(90, 230, 133, 19, "<basefont size=5 color=#E6FBFF><center>Oz's Static Tool", false, false);
