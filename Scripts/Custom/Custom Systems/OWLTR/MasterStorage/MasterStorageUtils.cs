...
namespace daat99
{
    public static class MasterStorageUtils
    {
		...
		public static bool GiveTypeToPlayer(PlayerMobile player, Type type, int amount, bool informPlayer)
		{
			...
			{
				if (informPlayer)
					player.SendMessage(1173, "Unable to add " + amount + " Tokens to your Master Storage.");
				return false;
			}
			if (informPlayer)
				player.SendMessage(1173, "You added " + amount + " Tokens to your Master Storage.");
			return true;
		}
		...
		public static bool TakeTypeFromPlayer(PlayerMobile player, Type type, int amount, bool informPlayer)
		{
			...
			{
				if (informPlayer)
					player.SendMessage(1173, "You don't have enough Tokens in your Master Storage.");
				return false;
			}
			if (informPlayer)
				player.SendMessage(1173, amount + " Tokens were removed from your Master Storage.");
			return true;
		}
