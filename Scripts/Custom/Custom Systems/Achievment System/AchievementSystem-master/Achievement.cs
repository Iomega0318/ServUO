...
namespace Server.Achievements
{
    ...
    public abstract class Achievement
    {
        ...
        public bool CheckAchievement(PlayerMobile m, object o)
        {
            ...
            {
                var tracker = TimedAchievementTracker.FindTracker(m, Identifier); 
            ...
            Timer.DelayCall(Delay, () =>
                {
                    ...
                    if (AchievementSystem.AwardSovereigns)
                    {
                        AwardSovereigns(pm);
                    }
        ...
        public virtual void OnProgress(PlayerMobile pm)
        {
            var profile = AchievementSystem.GetProfile(pm);

            if (profile != null)
            {
                OnProgress(pm, profile);
            }
        }
        ...
        public virtual void OnProgress(PlayerMobile pm, AchievementProfile profile)
        {
            ...
            if (progress < maxProgress && (profile.ShowProgress || progress == 1 || (maxProgress > 50 && progress % 10 == 0)))
            {
        ...
        public virtual void AwardSovereigns(PlayerMobile pm)
        {
            if (AchievementSystem.SovereignMultiplier > 0.0)
            {
    ...
    public class KillAchievementTimed : KillAchievement
    {
        ...
        /*public override void SendProgressionMessage(PlayerMobile pm, int progress, int maxProgress)
        {
            pm.SendLocalizedMessage(1060658, String.Format("You have made progress in the following achievement\t{0}", Name.ToString()), 2970);
        }*/
    }
        ...
        public override bool CheckAchievementMatch(PlayerMobile pm, object o)
        {
            ...
            switch (HarvestType)
            {
                ...
                case HarvestType.Special:
                    ...
                    return Definition.BonusResources != null && Definition.BonusResources.Any(br => br.Type == t);
            }
