        ...
        public static double HarvestExp(Mobile m, Item i, HarvestDefinition def, Map map, Point3D loc, HarvestResource resource)
        {
            ...
            if (resource is BaseOre)
            {
                ...
                if (bo.Resource == CraftResource.Iron)
                    ...
                    rtn += 9;
				//Daat99
				else if (bo.Resource == CraftResource.Blaze)
                    rtn += 10;
				else if (bo.Resource == CraftResource.Ice)
                    rtn += 11;
				else if (bo.Resource == CraftResource.Toxic)
                    rtn += 12;
				else if (bo.Resource == CraftResource.Electrum)
                    rtn += 13;
				else if (bo.Resource == CraftResource.Platinum)
                    rtn += 14;
				//Daat99
            }
            if (i is Fish)
            ...
            if (i is Log)
            {
                ...
                if (lo.Resource == CraftResource.RegularWood)
                    ...
                    rtn += 7;
				//Daat99
				else if (lo.Resource == CraftResource.Ebony)
                    rtn += 8;
				else if (lo.Resource == CraftResource.Bamboo)
                    rtn += 9;
				else if (lo.Resource == CraftResource.PurpleHeart)
                    rtn += 10;
				else if (lo.Resource == CraftResource.Redwood)
                    rtn += 11;
				else if (lo.Resource == CraftResource.Petrified)
                    rtn += 12;
				//Daat99
            }
        ...
        public static double CraftExp(Item i, int q, double c, double e, Mobile m)
        {
            ...
            if (i is BaseWeapon)
            {
                ...
                if (bw.Resource == CraftResource.Iron)
                    ...
                    rtn += 4.8;
				//Daat99
				else if (bw.Resource == CraftResource.Blaze)
                    rtn += 5.0;
				else if (bw.Resource == CraftResource.Ice)
                    rtn += 5.2;
				else if (bw.Resource == CraftResource.Toxic)
                    rtn += 5.4;
				else if (bw.Resource == CraftResource.Electrum)
                    rtn += 5.6;
				else if (bw.Resource == CraftResource.Platinum)
                    rtn += 5.8;
				//Daat99
                    ...
                    rtn += 4.8;
				//Daat99
				else if (bw.Resource == CraftResource.Ebony)
                    rtn += 5.0;
				else if (bw.Resource == CraftResource.Bamboo)
                    rtn += 5.2;
				else if (bw.Resource == CraftResource.PurpleHeart)
                    rtn += 5.4;
				else if (bw.Resource == CraftResource.Redwood)
                    rtn += 5.6;
				else if (bw.Resource == CraftResource.Petrified)
                    rtn += 5.8;
				//Daat99
                #endregion
            }
            else if (i is BaseArmor)
            {
                ...
                if (ba.Resource == CraftResource.Iron)
                    ...
                    rtn += 4.8;
				//Daat99
				else if (ba.Resource == CraftResource.Blaze)
                    rtn += 5.0;
				else if (ba.Resource == CraftResource.Ice)
                    rtn += 5.2;
				else if (ba.Resource == CraftResource.Toxic)
                    rtn += 5.4;
				else if (ba.Resource == CraftResource.Electrum)
                    rtn += 5.6;
				else if (ba.Resource == CraftResource.Platinum)
                    rtn += 5.8;
				//Daat99
                #endregion
                ...
                #region Wood
                    ...
                    rtn += 4.8;
				//Daat99
				else if (ba.Resource == CraftResource.Ebony)
                    rtn += 5.0;
				else if (ba.Resource == CraftResource.Bamboo)
                    rtn += 5.2;
				else if (ba.Resource == CraftResource.PurpleHeart)
                    rtn += 5.4;
				else if (ba.Resource == CraftResource.Redwood)
                    rtn += 5.6;
				else if (ba.Resource == CraftResource.Petrified)
                    rtn += 5.8;
				//Daat99
                #endregion
                ...
                #region Leathers
                    ...
                    rtn += 3.8;
				//Datt99
				else if (ba.Resource == CraftResource.PolarLeather)
                    rtn += 4.0;
				else if (ba.Resource == CraftResource.SyntheticLeather)
                    rtn += 4.2;
				else if (ba.Resource == CraftResource.BlazeLeather)
                    rtn += 4.4;
				else if (ba.Resource == CraftResource.DaemonicLeather)
                    rtn += 4.6;
				else if (ba.Resource == CraftResource.ShadowLeather)
                    rtn += 5.0;
				else if (ba.Resource == CraftResource.FrostLeather)
                    rtn += 5.4;
				else if (ba.Resource == CraftResource.EtherealLeather)
                    rtn += 5.8;
				//Datt99
                #endregion
                ...
                #region Scales 
                    ...
                    rtn += 1.0;
				//Datt99
				else if (ba.Resource == CraftResource.CopperScales)
                    rtn += 2.0;
				else if (ba.Resource == CraftResource.SilverScales)
                    rtn += 3.0;
				else if (ba.Resource == CraftResource.GoldScales)
                    rtn += 4.0;
				//Datt99
                #endregion
