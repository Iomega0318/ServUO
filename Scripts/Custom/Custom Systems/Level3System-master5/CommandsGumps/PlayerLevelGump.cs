...
namespace Server.Gumps
{
    public class PlayerLevelGump : Gump
    {
        ...
        private const int LabelHue = 1153; //1153 maybe
        private const int TitleHue = 1153;//0x12B
        private const int LabelHue2 = 1161;
		int hue = 1161;
        ...
        public void CreatePlayerStats(Mobile from)
        {
			...
			{
				AddButton(300, 295, 4005, 4007, GetButtonID(1, 70), GumpButtonType.Reply, 0);
				AddLabel(340, 295, LabelHue2, @"Master Stat Reset - No Confirmation!");
			}
			if(c.LevelSheetSkillResetButton == true)
			{
				AddButton(300, 325, 4005, 4007, GetButtonID(1, 71), GumpButtonType.Reply, 0);
				AddLabel(340, 325, LabelHue2, @"Master Skill Reset - No Confirmation!");
			}
            return;
