...
namespace Server
{
    ...
    {		
		...
		*/
		...
		public int	ForceStartingStatsSTR					= 75;
		public int	ForceStartingStatsDEX					= 75;
		public int	ForceStartingStatsINT					= 75;
		#endregion
		
		#region PlayerCaps
		public bool AutoActivate_StartingStrCap				= false;	/* Strength */
		public int	StartingStrCapVar						= 300;		/* Regular Cap 125 */
		public int	StartingStrCapMaxVar					= 500;		/* Cap Possible with Scrolls 150 */
		public bool AutoActivate_StartingDexCap				= false;	/* Dexterity */
		public int	StartingDexCapVar						= 300;		/* Regular Cap 125 */
		public int	StartingDexCapMaxVar					= 500;		/* Cap Possible with Scrolls 150 */
		public bool AutoActivate_StartingIntCap				= false;	/* Intelligence */
		public int	StartingIntCapVar						= 300;		/* Regular Cap 125 */
		public int	StartingIntCapMaxVar					= 500;		/* Cap Possible with Scrolls 150 */
		public bool AutoActivate_StartingTotalStatCap		= false;	/* Total Stat Cap */
		public int	AutoActivate_StartingTotalStatCapVar	= 900;		/* Regular Total Stat Cap 225*/
		...
		public int	AutoActivate_SkillsCapVar				= 70000;	
		#endregion
