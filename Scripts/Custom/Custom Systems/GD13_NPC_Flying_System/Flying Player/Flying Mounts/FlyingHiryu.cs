...
namespace Server.Mobiles
{
    ...
    public class FlyingHiryu : BaseMount
    {
        [Constructable]
        public FlyingHiryu() : base("a hiryu", 243, 0x3E94, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Hue = GetHue();
        ...
        public FlyingHiryu(Serial serial)
            : base(serial)
        {
        }
