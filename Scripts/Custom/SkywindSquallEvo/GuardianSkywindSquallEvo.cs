...
{
	[CorpseName( "a guardian skywind squall corpse" )]
	public class GuardianSkywindSquall : SkywindSquall
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianSkywindSquall() : base( "A Guardian Skywind Squall" )
		{
		

		Name = "Guardian Evo Skywind Squall";
            Body = 0XAF;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new SkywindSquallEgg() ); break;
            }	
       ...
       public GuardianSkywindSquall( Serial serial ) : base( serial )
          {
		}
