...
namespace Server.Items
{
    ...
    public class ExcAppChangeDeed : Item
    {
        private bool m_Redyable;

        [Constructable]
        public ExcAppChangeDeed()
            : base(0x14f0)
        {
            Weight = 0.0;
            Hue = 1199;
            Name = "Exceptional Appearance Change Deed"; //?????
            m_Redyable = false;
            LootType = LootType.Blessed;
        }

        public ExcAppChangeDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ACGump2 : Gump
    {
        ...
        public int m_cost;
        public int m;
        private ExcAppChangeDeed m_deed;  // Vii edit

        public ACGump2(ExcAppChangeDeed deed, Mobile from, Item item, Item mar, int mesg, bool dele) : base(100, 80)   // Vii edit
        {
            this.Closable = true;
        ...
        public class TransObject : Target
        {
            ...
            public bool obj;
            public int m;
            public ExcAppChangeDeed tdeed;  // Vii edit

            public int weaponitemID;

            public TransObject(ExcAppChangeDeed deed, Mobile from, Item item, Item mar, int mesg, bool dele, bool ob)
