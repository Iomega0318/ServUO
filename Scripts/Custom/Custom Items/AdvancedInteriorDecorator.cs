...
//        public override int LabelNumber { get { return 1041280; } } // an interior decorator
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (!InHouse(from))
                m_Command = AdvancedDecorateCommand.GetHue;
        ...
        private class InternalGump : Gump
        {
                ...
                : base(150, 50)
            {
                ...
                AddButton(40, 45, (decorator.Command == AdvancedDecorateCommand.Secure ? 2154 : 2152), 2154, 1, GumpButtonType.Reply, 0);
                AddLabel(80, 50, 0, @"Secure"); //secure

                AddButton(40, 85, (decorator.Command == AdvancedDecorateCommand.Lockdown ? 2154 : 2152), 2154, 2, GumpButtonType.Reply, 0);
                AddLabel(80, 90, 0, @"Lockdown"); // lockdown

                AddButton(40, 125, (decorator.Command == AdvancedDecorateCommand.Release ? 2154 : 2152), 2154, 3, GumpButtonType.Reply, 0);
                AddLabel(80, 130, 0, @"Release"); // release

                AddButton(40, 165, (decorator.Command == AdvancedDecorateCommand.Turn ? 2154 : 2152), 2154, 4, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 170, 70, 40, 1018323, false, false); // Turn

                AddButton(40, 205, (decorator.Command == AdvancedDecorateCommand.Up ? 2154 : 2152), 2154, 5, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 210, 70, 40, 1018324, false, false); // Up

                AddButton(40, 245, (decorator.Command == AdvancedDecorateCommand.Down ? 2154 : 2152), 2154, 6, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 250, 70, 40, 1018325, false, false); // Down

                AddButton(40, 285, (decorator.Command == AdvancedDecorateCommand.North ? 2154 : 2152), 2154, 7, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 290, 70, 40, 1075389, false, false); // north

                AddButton(40, 325, (decorator.Command == AdvancedDecorateCommand.East ? 2154 : 2152), 2154, 8, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 330, 70, 40, 1075387, false, false); // east

                AddButton(40, 365, (decorator.Command == AdvancedDecorateCommand.South ? 2154 : 2152), 2154, 9, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 370, 70, 40, 1075386, false, false); // south

                AddButton(40, 405, (decorator.Command == AdvancedDecorateCommand.West ? 2154 : 2152), 2154, 10, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 410, 70, 40, 1075390, false, false); // west

                AddButton(40, 445, (decorator.Command == AdvancedDecorateCommand.GetHue ? 2154 : 2152), 2154, 11, GumpButtonType.Reply, 0);
                AddHtmlLocalized(80, 450, 100, 20, 1158863, false, false); // Get Hue

                AddButton(40, 485, (decorator.Command == AdvancedDecorateCommand.Close ? 2154 : 2152), 2154, 13, GumpButtonType.Reply, 0);
