...
{
	public class CustomSpawnerDeed : Item
	{
		[Constructable]
		public CustomSpawnerDeed() : base(0x14F0)
		{
			Name = "Custom Creature Spawner at you House";
			Weight = 1.00;
			//Hue = 1;
		}

		public CustomSpawnerDeed( Serial serial ) : base( serial )
		{
        }
