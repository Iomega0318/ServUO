...
{
	public class CustomStealableDeed : Item
	{
		[Constructable]
		public CustomStealableDeed() : base(0x14F0)
		{
			Name = "Customer scripted Stealable";
			Weight = 1.00;
			//Hue = 1;
		}

		public CustomStealableDeed( Serial serial ) : base( serial )
		{
        }
