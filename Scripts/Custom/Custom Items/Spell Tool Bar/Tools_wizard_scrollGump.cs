...
{
	public class Tools_wizard_scrollGump : Gump
	{
		private Tools_wizard_scroll m_Scroll;

		public Tools_wizard_scrollGump( Mobile from, Tools_wizard_scroll scroll ) : base( 0, 0 )
		{
			m_Scroll = scroll;
	...
	public override void OnResponse( NetState state, RelayInfo info )
	{
		...
		switch ( info.ButtonID )
		{
			...
			case 99:
			{
				...
				from.SendGump( new Tools_wizard_scrollGump( from, m_Scroll ) );
				break;
			}
			case 1:
			{
			...
			case 64:
			{
				from.CloseGump( typeof( Tools_tools_wizard ) );
				from.SendGump( new Tools_tools_wizard( from, m_Scroll ) );
				break;
			}
		}
	}}

	public class Tools_tools_wizard : Gump
	{
		...
		public Tools_tools_wizard( Mobile from, Tools_wizard_scroll scroll ) : base( 0, 0 )
		{
			m_Scroll = scroll;
			this.Closable=false;
			this.Disposable=true;
		...
		{ 
			...
			{
				case 0: { break; }
				case 99: { if ( HasSpell( from, 0 ) ) { new ClumsySpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 1: { if ( HasSpell( from, 1 ) ) { new CreateFoodSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 2: { if ( HasSpell( from, 2 ) ) { new FeeblemindSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 3: { if ( HasSpell( from, 3 ) ) { new HealSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 4: { if ( HasSpell( from, 4 ) ) { new MagicArrowSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 5: { if ( HasSpell( from, 5 ) ) { new NightSightSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 6: { if ( HasSpell( from, 6 ) ) { new ReactiveArmorSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 7: { if ( HasSpell( from, 7 ) ) { new WeakenSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 8: { if ( HasSpell( from, 8 ) ) { new AgilitySpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 9: { if ( HasSpell( from, 9 ) ) { new CunningSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 10: { if ( HasSpell( from, 10 ) ) { new CureSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 11: { if ( HasSpell( from, 11 ) ) { new HarmSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 12: { if ( HasSpell( from, 12 ) ) { new MagicTrapSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 13: { if ( HasSpell( from, 13 ) ) { new RemoveTrapSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 14: { if ( HasSpell( from, 14 ) ) { new ProtectionSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 15: { if ( HasSpell( from, 15 ) ) { new StrengthSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 16: { if ( HasSpell( from, 16 ) ) { new BlessSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 17: { if ( HasSpell( from, 17 ) ) { new FireballSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 18: { if ( HasSpell( from, 18 ) ) { new MagicLockSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 19: { if ( HasSpell( from, 19 ) ) { new PoisonSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 20: { if ( HasSpell( from, 20 ) ) { new TelekinesisSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 21: { if ( HasSpell( from, 21 ) ) { new TeleportSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 22: { if ( HasSpell( from, 22 ) ) { new UnlockSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 23: { if ( HasSpell( from, 23 ) ) { new WallOfStoneSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 24: { if ( HasSpell( from, 24 ) ) { new ArchCureSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 25: { if ( HasSpell( from, 25 ) ) { new ArchProtectionSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 26: { if ( HasSpell( from, 26 ) ) { new CurseSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 27: { if ( HasSpell( from, 27 ) ) { new FireFieldSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 28: { if ( HasSpell( from, 28 ) ) { new GreaterHealSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 29: { if ( HasSpell( from, 29 ) ) { new LightningSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 30: { if ( HasSpell( from, 30 ) ) { new ManaDrainSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 31: { if ( HasSpell( from, 31 ) ) { new RecallSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 32: { if ( HasSpell( from, 32 ) ) { new BladeSpiritsSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 33: { if ( HasSpell( from, 33 ) ) { new DispelFieldSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 34: { if ( HasSpell( from, 34 ) ) { new IncognitoSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 35: { if ( HasSpell( from, 35 ) ) { new MagicReflectSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 36: { if ( HasSpell( from, 36 ) ) { new MindBlastSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 37: { if ( HasSpell( from, 37 ) ) { new ParalyzeSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 38: { if ( HasSpell( from, 38 ) ) { new PoisonFieldSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 39: { if ( HasSpell( from, 39 ) ) { new SummonCreatureSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 40: { if ( HasSpell( from, 40 ) ) { new DispelSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 41: { if ( HasSpell( from, 41 ) ) { new EnergyBoltSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 42: { if ( HasSpell( from, 42 ) ) { new ExplosionSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 43: { if ( HasSpell( from, 43 ) ) { new InvisibilitySpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 44: { if ( HasSpell( from, 44 ) ) { new MarkSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 45: { if ( HasSpell( from, 45 ) ) { new MassCurseSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 46: { if ( HasSpell( from, 46 ) ) { new ParalyzeFieldSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 47: { if ( HasSpell( from, 47 ) ) { new RevealSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 48: { if ( HasSpell( from, 48 ) ) { new ChainLightningSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 49: { if ( HasSpell( from, 49 ) ) { new EnergyFieldSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 50: { if ( HasSpell( from, 50 ) ) { new FlameStrikeSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 51: { if ( HasSpell( from, 51 ) ) { new GateTravelSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 52: { if ( HasSpell( from, 52 ) ) { new ManaVampireSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 53: { if ( HasSpell( from, 53 ) ) { new MassDispelSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 54: { if ( HasSpell( from, 54 ) ) { new MeteorSwarmSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 55: { if ( HasSpell( from, 55 ) ) { new PolymorphSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 56: { if ( HasSpell( from, 56 ) ) { new EarthquakeSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 57: { if ( HasSpell( from, 57 ) ) { new EnergyVortexSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 58: { if ( HasSpell( from, 58 ) ) { new ResurrectionSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 59: { if ( HasSpell( from, 59 ) ) { new AirElementalSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 60: { if ( HasSpell( from, 60 ) ) { new SummonDaemonSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 61: { if ( HasSpell( from, 61 ) ) { new EarthElementalSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 62: { if ( HasSpell( from, 62 ) ) { new FireElementalSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
				case 63: { if ( HasSpell( from, 63 ) ) { new WaterElementalSpell( from, null ).Cast(); from.SendGump( new Tools_tools_wizard( from, m_Scroll ) ); } break; }
			}
		}
	}
}