...
{
	public class MagicalShortbowOfEvolution : MagicalShortbow
	{
		...
		[Constructable]
		public MagicalShortbowOfEvolution()
		{	Name = "Magical Shortbow Of Evolution";
			Hue = 0x4F2;
        ...
        public MagicalShortbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Magical Shortbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
