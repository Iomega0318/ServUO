...
{
	public class TribalSpearOfEvolution : TribalSpear
	{
		...
		[Constructable]
		public TribalSpearOfEvolution()
		{	Name = "Tribal Spear Of Evolution";
			Hue = 0x4F2;
        ...
        public TribalSpearOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Tribal Spear Of Evolution (" + mEvolutionPoints.ToString() + ")";
