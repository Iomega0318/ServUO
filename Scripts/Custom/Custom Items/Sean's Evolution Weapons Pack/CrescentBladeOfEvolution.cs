...
{
    public class CrescentBladeOfEvolution : CrescentBlade
    {
	...
	public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.WhirlwindAttack; } }
        ...
        [Constructable]
        public CrescentBladeOfEvolution()
        {
            Name = "Crescent Blade Of Evolution";
            Hue = 0x4F2;
        ...
        public CrescentBladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Crescent Blade Of Evolution (" + mEvolutionPoints.ToString() + ")";
