...
{
	public class RuneBladeOfEvolution : RuneBlade
	{
		...
		[Constructable]
		public RuneBladeOfEvolution()
		{	Name = "Rune Blade Of Evolution";
			Hue = 0x4F2;
        ...
        public RuneBladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Rune Blade Of Evolution (" + mEvolutionPoints.ToString() + ")";
