...
{
	public class GlacialStaffOfEvolution : GlacialStaff
	{
		...
		[Constructable]
		public GlacialStaffOfEvolution()
		{	Name = "Glacial Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public GlacialStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Glacial Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
