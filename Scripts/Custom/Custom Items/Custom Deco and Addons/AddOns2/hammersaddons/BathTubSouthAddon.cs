...
{
	public class BathTubSouthAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new BathTubSouthAddonDeed();
			}
		}

		[ Constructable ]
		public BathTubSouthAddon()
		{
			AddComponent( new AddonComponent( 1802 ), 0, 2, 0 );
			AddComponent( new AddonComponent( 2921 ), 0, -1, 0 );
			AddComponent( new AddonComponent( 13456 ), 0, -1, 1 );
			AddComponent( new AddonComponent( 2921 ), -2, -1, 0 );
			AddComponent( new AddonComponent( 13456 ), -2, -1, 1 );
			AddComponent( new AddonComponent( 2921 ), -2, 0, 0 );
			AddComponent( new AddonComponent( 13456 ), -2, 0, 1 );
			AddComponent( new AddonComponent( 1812 ), -2, 2, 0 );
			AddComponent( new AddonComponent( 2921 ), 0, 0, 0 );
			...
			AddComponent( new AddonComponent( 2920 ), -1, -1, 0 );
			...
			AddComponent( new AddonComponent( 2920 ), -1, 0, 0 );
		...
		public BathTubSouthAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BathTubSouthAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new BathTubSouthAddon();
			}
		}

		[Constructable]
		public BathTubSouthAddonDeed()
		{
			Name = "BathTubSouth";
		}

		public BathTubSouthAddonDeed( Serial serial ) : base( serial )
		{
		}
