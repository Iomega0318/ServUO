...
namespace Server.Items
{
	public class TravelAtlas : Item
	{
		...
		public static void Initialize()
		{
			...
			{
				new TAEntry("City of the Sun", new Point3D(5251, 387, 17), Map.Trammel ),
				//new TAEntry("Gate Room", new Point3D(6079, 451, -22), Map.Felucca ),
				new TAEntry("Training Room", new Point3D(5731, 1009, 7), Map.Trammel ),
                //new TAEntry("The Expedition", new Point3D(5395, 1419, 0), Map.Trammel ),
                new TAEntry("Hue Room", new Point3D(5155, 1065, 0), Map.Trammel ),
			...
			{
				new TAEntry("Green Acres Trammel", new Point3D(5445, 1153, 0), Map.Trammel ),
				new TAEntry("Green Acres Felucca", new Point3D(5445, 1153, 0), Map.Felucca ),
				new TAEntry("Jail Trammel", new Point3D(5296, 1173, 0), Map.Trammel ),
				new TAEntry("Jail Felucca", new Point3D(5296, 1173, 0), Map.Felucca ),
				new TAEntry("Star Room Trammel", new Point3D(5146, 1774, 0), Map.Trammel ),
				new TAEntry("Star Room Felucca", new Point3D(5146, 1774, 0), Map.Felucca )
			});
