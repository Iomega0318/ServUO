...
{
	public class FemaleGargoyleSoulArmsOfATA : LeatherArms
	{
		...
		[Constructable]
		public FemaleGargoyleSoulArmsOfATA()
		{
			Hue = 1154;
			ItemID = 769;
			
			Name = "Female Gargoyle Soul Arms Of ATA";
		...
		public FemaleGargoyleSoulArmsOfATA( Serial serial ) : base( serial )
		{
		}
