...
{
	public class FemaleGargoyleSoulLegsOfATA : ChainLegs
	{
		...
		[Constructable]
		public FemaleGargoyleSoulLegsOfATA()
		{
			ItemID = 773;
            Hue = 1154;
            Name = "Female Gargoyle Soul Legs Of ATA";
...
;
		...
		public FemaleGargoyleSoulLegsOfATA( Serial serial ) : base( serial )
		{
		}
