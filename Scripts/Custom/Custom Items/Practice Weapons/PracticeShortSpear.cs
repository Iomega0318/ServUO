...
namespace Server.Items
{
	...
	public class PracticeShortSpear : BaseSpear
	{
		...
		[Constructable]
		public PracticeShortSpear() : base( 0x1403 )
		{
			Weight = 4.0;
			Name = "Shortspear [Practice Weapon]";
			LootType = LootType.Newbied;
		}

		public PracticeShortSpear( Serial serial ) : base( serial )
		{
		}
