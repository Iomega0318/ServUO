...
namespace Server.Items
{
	...
	public class PracticePitchfork : BaseSpear
	{
		...
		[Constructable]
		public PracticePitchfork() : base( 0xE87 )
		{
			Weight = 11.0;
			Name = "Pitchfork [Practice Weapon]";
			LootType = LootType.Newbied;
		}

		public PracticePitchfork( Serial serial ) : base( serial )
		{
		}
