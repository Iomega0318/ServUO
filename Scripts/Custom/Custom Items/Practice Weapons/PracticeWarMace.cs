...
namespace Server.Items
{
	...
	public class PracticeWarMace : BaseBashing
	{
		...
		[Constructable]
		public PracticeWarMace() : base( 0x1407 )
		{
			Weight = 17.0;
			Name = "War Mace [Practice Weapon]";
			LootType = LootType.Newbied;
		}

		public PracticeWarMace( Serial serial ) : base( serial )
		{
		}
