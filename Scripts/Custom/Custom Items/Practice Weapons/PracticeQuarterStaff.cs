...
namespace Server.Items
{
	...
	public class PracticeQuarterStaff : BaseStaff
	{
		...
		[Constructable]
		public PracticeQuarterStaff() : base( 0xE89 )
		{
			Weight = 4.0;
			Name = "Quarterstaff [Practice Weapon]";
			LootType = LootType.Newbied;
		}

		public PracticeQuarterStaff( Serial serial ) : base( serial )
		{
		}
