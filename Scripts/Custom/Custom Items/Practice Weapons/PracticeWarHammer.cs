...
namespace Server.Items
{
	...
	public class PracticeWarHammer : BaseBashing
	{
		...
		[Constructable]
		public PracticeWarHammer() : base( 0x1439 )
		{
			Weight = 10.0;
			Layer = Layer.TwoHanded;
			Name = "Warhammer [Practice Weapon]";
			LootType = LootType.Newbied;
		}

		public PracticeWarHammer( Serial serial ) : base( serial )
		{
		}
