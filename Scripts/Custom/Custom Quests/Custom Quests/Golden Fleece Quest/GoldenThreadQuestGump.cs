...
"<BASEFONT COLOR=YELLOW>Please Help!! I was attacked by wolfs<BR>" +
"<BASEFONT COLOR=YELLOW>Just north of here. Smit them and Ill hook you up.<BR>" +
"<BASEFONT COLOR=YELLOW>Search for Scottie's attacker, a wolf<BR>" +
"<BASEFONT COLOR=YELLOW>in the north of haven.<BR>" +
