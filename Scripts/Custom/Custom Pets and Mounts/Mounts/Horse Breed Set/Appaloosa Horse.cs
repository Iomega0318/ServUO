...
{
	[CorpseName( "a Appaloosa Horse corpse" )]
	public class AppaloosaHorse : BaseMount
	{
		[Constructable]
		public AppaloosaHorse() : this( "a Appaloosa Horse" )
		{
		}

		[Constructable]
		public AppaloosaHorse( string name ) : base( name, 0xBE, 0x3E9E, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Hue = 796;
		...
		public AppaloosaHorse( Serial serial ) : base( serial )
		{
		}
