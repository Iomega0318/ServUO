...
{
	[CorpseName( "a American Quarter Horse corpse" )]
	public class AmericanQuarterHorse : BaseMount
	{
		[Constructable]
		public AmericanQuarterHorse() : this( "a American Quarter Horse" )
		{
		}

		[Constructable]
		public AmericanQuarterHorse( string name ) : base( name, 0xBE, 0x3E9E, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Hue = 743;
		...
		public AmericanQuarterHorse( Serial serial ) : base( serial )
		{
		}
