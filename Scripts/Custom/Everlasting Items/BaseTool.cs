...
namespace Server.Items
{
    ...
    public abstract class EverlastingBaseTool : Item, ITool, IResource, IQuality
    {
        ...
        public EverlastingBaseTool(int uses, int itemID)
            : base(itemID)
        {
        ...
        public EverlastingBaseTool(Serial serial)
            : base(serial)
        {
        }
