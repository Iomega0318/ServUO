...
namespace Server
{
	public class LevelItems
	{
        ...
        public static readonly int DefaultMaxLevel = 15; //Default Max level for items.
        ...
        public const double BlacksmithSkillRequired = 120; // Amount of Blacksmith skill required to validate deeds (if BlacksmithOnly is true).
        public const bool RewardBlacksmith = true; //true = give the blacksmith reward for validating (if BlacksmithOnly is true).
        public const int BlacksmithRewardAmt = 25000; // Amount to pay blacksmith if they validate deed for another player (if BlacksmithOnly and RewardBlacksmith are true).
	}
}
