...
namespace Server.Engines.XmlSpawner2
{
	...
	public class XmlSockets : XmlAttachment
	{
		...
		public static int DefaultMaxSockets = 5;
		...
		public static double DefaultSocketDifficulty = 100.0;//100
        
		public static SkillName DefaultSocketSkill = SkillName.Blacksmith;

		public static Type DefaultSocketResource = typeof(PlatinumIngot);//Valorite Ingot

		public static int DefaultSocketResourceQuantity = 75;//50
		...
		public override string OnIdentify(Mobile from)
		{
			...
			{
				//return String.Format("<basefont color=#38761d>{0} Sockets {1} available</basefont>", NSockets, NFree);
                //"<basefont color='38761d'>Text Goes Here.</basefont>"
                if (NSockets == 1)
                {
                    return String.Format("<basefont color=#38761d>{0} Socket {1} available</basefont>", NSockets, NFree);
                }
                else if (NSockets > 1)
                {
                    return String.Format("<basefont color=#38761d>{0} Sockets {1} available</basefont>", NSockets, NFree);
