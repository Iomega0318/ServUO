    ...
    //            return 250 - (Level * 12);
        ...
        public void OnSlice()
        {
            ...
            if (m_Champion != null)
            {
                if (m_Champion.Deleted)
                {
                    ...
                    if (m_Type != ChampionSpawnType.AncientBlacksmith) //Modified for ancient blacksmith
        ...
        public void SpawnChampion()
        {
            ...
            if (m_Champion != null)
            {
                ...
                //Added for Ancient Smithy
                if (m_Type == ChampionSpawnType.AncientBlacksmith)
                {
                    AncientSmithy smith = m_Champion as AncientSmithy;
                    smith.ChampionSpawn = true;
                    smith.MoveToWorld(new Point3D(X, Y, Z - 15), Map);
                }
                else
                //End Add
